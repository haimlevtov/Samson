...
**Blocked on an OpenRouter key, not on work** — eight of the twenty-one open items
below, and worth
...
| [rework, 6b](rework-hub-history-coach.md) | No coach voice has been heard yet. The key was not enough: the first presses were refused for credit, then for the format (fixed in #50, unpressed since); the five castings in `20260911140100` are unheard |
