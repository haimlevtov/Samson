...
| 2    | Starting an empty session instead, or logging today as a rest day (ADR 0034) |
| 3    | Building or importing a template                                             |

**A rest day is today's, and only today's.** Rest today sits beside Start an
empty workout because it answers the same question. It takes no date: the server
reads the user's own. It is not offered while a session runs, and not on a day
that already has training in it. The database allows one rest row per date.
...
| **Rest today offered**                            | A secondary "Rest today" under Start an empty workout, with "Keeps your streak, and pays what a session in its place would." under it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Rest today pressed**                            | The day is logged and lands on its receipt, "Rest day kept": what it earned, the week against its cap, the streak, and a badge if one fired. While the press is pending the button reads "Logging your rest day…" and ignores another tap, which would replace the receipt with one that carries no badge. A press on a day already logged lands on that day's receipt and pays it if its award had not gone through.                                                                                                                                                                                                                                                                                   |
| **Today is already a rest day**                   | Quick start says "Today is logged as a rest day." and links to that day's receipt, "See the rest day", in place of Rest today. Start an empty workout stays: training on a rest day is allowed, and the rest day stays logged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Today already has a session**                   | "You trained today, so it is not a rest day." in place of Rest today — when a finished or unfinished session that day has sets in it. An empty session, a mis-tapped Start, does not count, because nothing can delete one.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
