...
| **Coach changed after a delivery**                | The delivered words stay, under "What The Analyst says" naming the coach who wrote them rather than the one the menu now shows, and a gentle-tone note names the same coach. Delivering again replaces both with the selected coach's. Hiding the delivery instead would make it vanish on the first Try with nothing saying where it went.                                                                                                                                                                                                                                                                                                                                                             |
